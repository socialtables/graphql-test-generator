...
if (program.entry && program.output && program.schema) {
	graphqlTestGenerator({ entry: program.entry, output: program.output, schemaLocation: program.schema, overwriteFiles: program.replace, importLocation: program.testGeneratorFunction });	
}